    ...
    public partial class SeedingDataForDifficultiesandRegion : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("914d9784-a607-4387-a198-c86512be7964"), "Hard" },
                    { new Guid("ea292979-6ff1-4766-9fb6-f7cdec85e4be"), "Easy" },
                    { new Guid("f50d7881-6076-4bbf-ad87-fc689c8500df"), "Medium" }
                });
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.DeleteData(
                table: "Difficulties",
                keyColumn: "Id",
                keyValue: new Guid("914d9784-a607-4387-a198-c86512be7964"));

            migrationBuilder.DeleteData(
                table: "Difficulties",
                keyColumn: "Id",
                keyValue: new Guid("ea292979-6ff1-4766-9fb6-f7cdec85e4be"));

            migrationBuilder.DeleteData(
                table: "Difficulties",
                keyColumn: "Id",
                keyValue: new Guid("f50d7881-6076-4bbf-ad87-fc689c8500df"));
